...
// link      :      https://github.com/EddyVerbruggen/Toast-PhoneGap-Plugin
    ...
    angular.module('ngCordova.plugins.chcp', [])
        .factory('$cordovaChcp', ["$xztbPopup", function ($xztbPopup) {
            ...
            var app = {
                ...
                configurePlugin: function () {
                    var options = {
                        'config-file': 'http://192.168.90.26:3000/www/chcp.json'
                    };
                ...
                fetchUpdateCallback: function (error, data) {
                    ...
                    var confirmPopup = $xztbPopup.confirm({
                        title: '版本升级',
                        template: '是否升级版本', //从服务端获取更新的内容
                        cancelText: '取消',
                        okText: '升级'
                    });
                    ...
                    confirmPopup.then(function (res) {
                        ...
                        if (res) {
                            ...
                            // 取消更新
                            xzNavigationTool.navgationClose();
                        }
                    });
                },
